...
public class PopularAdapter extends RecyclerView.Adapter<PopularAdapter.viewHolder> {
    ...
    public void onBindViewHolder(@NonNull viewHolder holder, int position) {
        ...
        int drawableResourceId2 = holder.itemView.getContext().getResources().getIdentifier("popular_background","drawable",holder.itemView.getContext().getPackageName());
        ...
        holder.item_layout.setOnClickListener(new View.OnClickListener(){
            ...
            public void onClick(View v) {
                Log.d("popular sent data","trying");
                ...
                Log.d("popular sent data","success");
            }
        });
